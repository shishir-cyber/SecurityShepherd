...
/**
 * The control class of the Create New Administrator functionality. <br>
 * <br>
...
public class CreateNewAdmin extends HttpServlet {
  ...
  private static final Logger log = LogManager.getLogger(CreateNewAdmin.class);

  /**
   * Initiated by createNewAdmin.jsp. This method adds administrators to the system if valid data is
   * submitted, otherwise no admin will be added to the database. Email is gathered for future
   * functionality. Adding of the player to the core database is handed by Setter.playerCreate
   *
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (Validate.validateAdminSession(ses, tokenCookie, tokenParmeter)) {
      ...
      if (Validate.validateTokens(tokenCookie, tokenParmeter)) {
        ...
        try {
          ...
          if (basicValidation && userValidate) {
            ...
            Setter.userCreate(
                ApplicationRoot, null, userName, passWord, "admin", userAddress, true);
            if (userAddress.isEmpty()) {
            ...
            String reponseMessage =
                "<a>"
                    ...
                    + "</a> created successfully with email address "
                    + Encode.forHtml(userAddress);
            out.print("<h3 class=\"title\">Admin Created</h3>" + "<p>" + reponseMessage + "<p>");
          } else {
            ...
            out.print(
                "<h3 class=\"title\">Admin Create Failure</h3>"
                    + "<p><font color=\"red\">"
      ...
      out.print(
          "<h3 class=\"title\">Admin Create Failure</h3><p><font color=\"red\">An error Occurred!"
              + " Please try non administrator functions!</font><p>");
    }
